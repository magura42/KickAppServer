...
class TournamentController @Inject()(personDao: PersonDAO, tournamentDAO: TournamentDAO,
  trainingparticipantDao: TrainingparticipantDAO) extends CommonController(personDao) {
