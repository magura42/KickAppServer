...
object Teameventparticipant {

  case class Teameventparticipant(teameventparticipantid: Int, participantid: Int, teameventid: Int, role: Role,
  ...
  implicit val userWrites = Json.writes[Teameventparticipant]
  implicit val userReads = Json.reads[Teameventparticipant]
}
